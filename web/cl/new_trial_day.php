...
if ($state==0){    //state = 0 - new window
    ...
    echo "<form target = '_self' method = 'post'><table style='width:100%'><tr><th>First name</th><th>Surname</th><th>Job title</th></tr>";
    ...
    echo "<table style='width:100%'><tr><th>First name</th><th>Surname</th><th>Job title</th><th>Update</th><th>Remove</th></tr>";
    }
    while ($row=$db->Row()){
