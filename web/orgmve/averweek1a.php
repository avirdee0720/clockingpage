...
$tytul='Average attendance All days (Mon-Sun)<BR>';
...
<td class='DataTD'>   <select class='Select' name='_grp'>
		<option selected value='r'>Regulars</option>
...
elseif($state==1)
{
   ...
   echo "<script language='javascript'>window.location=\"averweek1b.php?startd=$startd&endd=$endd&_grp=$_grp&showall=$showall\"</script>";
} //fi state=1
else
{
