...
<table WIDTH=100% bordercolorlight='black' border='border' style='border-collapse: collapse; background-color: white' >
  <tr>
	 ...
	 <td class='FieldCaptionTD'><A HREF='$PHP_SELF?sort=2&kier=$kier&startd=".$_GET['startd']."&endd=".$_GET['endd']."'><B>Surname</B>$kier_img[2]</A></td>
      <td class='FieldCaptionTD'><B>Days</B></A></td>
     <td class='FieldCaptionTD'><B>Hours</B></td>
     <td class='FieldCaptionTD'><B>Average Hours<BR> per Day </B></td>
     <td class='FieldCaptionTD'><B>Weekend Days</B></A></td>
     <td class='FieldCaptionTD'><B>Weekend Hours</B></td>
     <td class='FieldCaptionTD'><B>Average Weekend Hours<BR> per Day </B></td>
     <td class='FieldCaptionTD'><B>Days<BR>Prev 12 Months</B></td>
     <td class='FieldCaptionTD'><B>Hours<BR>Prev 12 Months</B></td>
     <td class='FieldCaptionTD'><B>Average Hours<BR>Prev 12 Months</B></td>
		</tr>	
";
/* 
...
$prac1 =("SELECT DISTINCT `pno`, `firstname`, `surname`, `knownas`
 FROM `nombers` inner join `totals` ON nombers.pno = totals.no WHERE totals.date1>='$dod' AND date1<='$ddo'");
