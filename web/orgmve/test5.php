...
function ToolPMenu($clockingNO, $option){
	if($option == 1) {
        $menuP = "<a CLASS='DataLink' href='advance1.php?cln=$clockingNO'><IMG SRC='images/expand_row.gif' WIDTH='16' HEIGHT='16' BORDER='0' ALT='PAYs'></a>
        <a CLASS='DataLink' href='pay01.php?cln=$clockingNO'><IMG SRC='images/cons_report.gif' WIDTH='16' HEIGHT='16' BORDER='0' ALT='PAYs'></a>
        <a CLASS='DataLink' href='t_of_staff.php?cln=$clockingNO'><IMG SRC='images/last1hr.gif' WIDTH='16' HEIGHT='16' BORDER='0' ALT='Clocking'></a>
        <a CLASS='DataLink' href='hollid1.php?cln=$clockingNO'><IMG SRC='images/hollidays.gif' WIDTH='16' HEIGHT='16' BORDER='0' ALT='Holidays'></a>
        <a CLASS='DataLink' href='ed_os_k.php?lp=$clockingNO'><IMG SRC='images/ipgrp.gif' WIDTH='16' HEIGHT='16' BORDER='0' ALT='Properites'></a>
        <a CLASS='DataLink' href='ed_os_s.php?lp=$clockingNO'><IMG SRC='images/home.gif' WIDTH='16' HEIGHT='16' BORDER='0' ALT='EDIT SHOP'></a>
        <a CLASS='DataLink' href='ed_os.php?lp=$clockingNO'><IMG SRC='images/edit.png' BORDER='0' ALT='EDIT'></a>
        <a CLASS='DataLink' href='del_os.php?cln=$clockingNO'><IMG SRC='images/drop.png' BORDER='0' ALT='DELETE'></a>";
		return $menuP;
	} else {
		$opis = "<IMG SRC='images/expand_row.gif' WIDTH='16' HEIGHT='16' BORDER='0' ALT='PAYs'> ADANCES
...
function Entitlement( $catCasual, $RegDay, $startedDAY, $ENYearStart ){
	...
	if($HowManyDaysFromStart < 365) {
	 ...
	 if($catCasual=="y") { 		
		  $PLEntitlement = round(4 * $PerCentInYear);
	 } else {  
		  $PLEntitlement = round((4 * $RegDay) * $PerCentInYear);
	 }
	} else {

		if($catCasual=="n") { $PLEntitlement = 4 * $RegDay;
		} else { $PLEntitlement = 4 ; }
	}

	return array( $PLEntitlement, $PerCent, $HowManyDaysFromStart );
}
