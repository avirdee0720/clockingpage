...
$tytul='0.8 weekend days of at least 7 hours required: non-qualifiers<BR>';
...
if (!isset($limitvalid)) $limitvalid=0; 
   echo "<script language='javascript'>window.location=\"aver0_8weekend_7h_1b.php?startd=$startd&endd=$endd&_grp=$_grp&limit=$limit&dir=$dir&lv=$limitvalid\"</script>";
} //fi state=1
else
{
