...
$db2 = new CMySQL;
$db3 = new CMySQL;
$tytul='MVE security consolidation/delivery scenario debriefing sheet (banking)<BR>';
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<A HREF='ss_dayb.php?month=01'>1</a>
<A HREF='ss_dayb.php?month=02'>2</a>
<A HREF='ss_dayb.php?month=03'>3</a>
<A HREF='ss_dayb.php?month=04'>4</a>
<A HREF='ss_dayb.php?month=05'>5</a>
<A HREF='ss_dayb.php?month=06'>6</a>
<A HREF='ss_dayb.php?month=07'>7</a>
<A HREF='ss_dayb.php?month=08'>8</a>
<A HREF='ss_dayb.php?month=09'>9</a>
<A HREF='ss_dayb.php?month=10'>10</a>
<A HREF='ss_dayb.php?month=11'>11</a>
<A HREF='ss_dayb.php?month=12'>12</a>

</font>&nbsp;&nbsp;&nbsp;&nbsp;
<input CLASS='Button'  type='Button' onclick='window.location=\"ss_nbank.php\"' value='New bankings'>
(<IMG SRC='images/edit.gif' WIDTH='15' HEIGHT='15' BORDER='0'> - EDIT)
<BR>
...
echo " <tr><td CLASS='DataTD10'>&nbsp;</td>";
  if ($db->Query($q)) 
  {
    while ($row=$db->Row())
    {
     echo "<td CLASS='DataTD10'>$row->d1<A HREF='ss_ebank.php?data=$Year-$month-$row->d1'><IMG SRC='images/edit.gif' WIDTH='15' HEIGHT='15' BORDER='0'></A></td>";
