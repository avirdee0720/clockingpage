...
<CENTER>
<br>
<font class='infoHeaderFont'>Dooks (cl.no. 2574) attendance information:<br>
<?php

if (($startd != 0) and ($endd != 0))
    echo "From: $startd to: $endd";
...
<form action='<?php echo $_SERVER['PHP_SELF']; ?>' method='post' name='periodselect'>
    ...
    <img src="img/cal.gif" onclick="javascript:NewCssCal ('datepicker','ddMMyyyy','arrow')" style="cursor:pointer"></td>
    <td><b>Date to: </b><input type="text" name="endd" id="datepicker2" maxlength="12" size="12">
    <img src="img/cal.gif" onclick="javascript:NewCssCal ('datepicker2','ddMMyyyy','arrow')" style="cursor:pointer"></td>
    </tr>
    <tr>
    <td colspan="2"><input class='Button' name='ok' type='submit' value='OK!'>
    </td>
    </tr>
</form>
</table>    
