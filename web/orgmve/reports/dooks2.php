...
0.5 day attendance if: 4 hours < working hours < 8 hours<br>
1 day attendance if: 8 hours < working hours<br></font>
<br>
...
WHERE `no` = '2574'";    
    ...
    for ($w = $minweek; $w <= $maxweek; $w++) {
       ...
       CASE
          WHEN SUM(`sumsec`) < 14400 THEN 0
          WHEN 14400 < SUM(`sumsec`) AND SUM(`sumsec`) < 30600 THEN 0.5
          WHEN 28800 < SUM(`sumsec`) THEN 1
       END
          AS att
  FROM (SELECT `id`,
               `date1`,
