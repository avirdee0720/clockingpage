...
$tytul='Te same numery serujne programów.';
$nP="$PHP_SELF";
...
<td class='FieldCaptionTD'><A HREF='$PHP_SELF?sort=2'><B>SN</B></A></td>
...
switch ($sort)
  ...
  if (!$db->Query($q)) $db->Kill();
    ...
    echo "<tr>
        <td class='DataTD'><A HREF='zest2sn.php'><B>$row->prg_nazwa</B></A></td>
        <td class='DataTD'><B>$row->nrs</B></td>
