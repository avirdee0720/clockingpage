...
if( $emp->wendbonus == 1 ) { 
	...
	if($emp->paystru=="OLD")
	{
			...
			if($WeekendDaysToDate > 45) { 
				...
				//	if($AVWeekendDays >= 3.75) {
					 ...
					 $WeekendsDay45 = WeekendsDays45($clockinginno,$BonusYearStart,$dod,$CurrentBonusYearEnd);
	...
	if($WendBonus > 0.1) {
		echo "<TR><TD>$emp->pno - $WeekendsDay45</TD><TD>$emp->wendbonus</TD><TD>$emp->paystru </TD><TD>  $WeekenDayTotal </TD><TD> $WeekendHoursTotal </TD><TD> £ $WendBonus to add: $WeekendAdd </TD><TD>
