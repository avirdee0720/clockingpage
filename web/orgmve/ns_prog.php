...
$tytul='Nowy programy do zestawu: $idzest';
...
<tr>
        ...
        <td class='DataTD'><INPUT class='Input' NAME='_Dostawca' onChange=\"this.value=this.value.toUpperCase()\"></td>
		<td class='FieldCaptionTD'>Model</td>
        <td class='DataTD'><INPUT class='Input' NAME='_Model' onChange=\"this.value=this.value.toUpperCase()\"></td>
</tr>
</TD></tr>
</table></tr>
  <tr>
...
if(isset($Nowy) and $Nowy=='Zapisz')
    ...
    $query =("INSERT INTO monitor (id_mon, Nr_ewidencyjny, Nr_seryjny, Rok_prod, Producent, Model) VALUES(NULL, '$_Nr_ewid', '$_Nr_seryjny', '$_Rok_prod', '$_Dostawca', '$_Model')");
	$result = mysql_query($query);
	$idmon=mysql_insert_id();
	echo "<script language='javascript'>window.location=\"ns_mon.php\"</script>";
