  ...
  if ($db->Query($sql)) 
  {
    while ($row=$db->Row())
    {
     echo "<tr>
		...
		<td class='DataTD'><A HREF='#' onClick='display(admin.php, 200, 200)'>Display</A></td>
	  </tr>  ";
  } 
} else {
echo " 
...
<TR>
<TD>
<div id='pay'><span style=\"cursor: pointer; text-decoration: underline\"
    onclick=\"makeRequest('admin.php')\">
        Make a request
</span>
