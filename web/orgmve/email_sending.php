  ...
  <tr>
    ...
    <tr>
      <td align='right' colspan='2'>
		<input name='no' type='hidden' value='$cln'>
		<input name='email1' type='hidden' value='$email1'>
...
elseif($state==1)
{
 ...
 $email1=$_POST['email1'];
  ...
  _mail_send ($email1, $_text,$attachment);
