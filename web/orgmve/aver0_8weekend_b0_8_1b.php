...
$title="Average 0.8 weekend days per week required: non-qualifiers below 0.8";
...
<table bordercolorlight='black' border='border' style='border-collapse: collapse; background-color: white' >
  <tr>
     ...
     <td class='FieldCaptionTD'><B>Weekend days</B></td>
     <td class='FieldCaptionTD'><B>Hours/day</B></td>
...
if (round($row2->wenddaynumberweek,2)<0.8) {		
   	 echo " <tr>
