...
if (!isset($_POST['_grp'])) $DepGroup = 0; else $DepGroup = $_POST['_grp'];
...
$q="SELECT DISTINCT `pno`,
 ...
 WHERE `nombers`.`cat`!='ui'
       AND (`status` = 'OK' OR DATEDIFF(now(), `inout`.`date1`) <= 60)
...
<table border='0' cellpadding='2' cellspacing='1' CLASS='FormTABLE'>
  <tr>
    ...
    <td CLASS='ColumnTD2' nowrap=\"nowrap\"><div align=\"center\">
        ...
        <td CLASS='ColumnTD2' nowrap=\"nowrap\"><div align=\"center\">
                <A HREF='$PHP_SELF?sort=3&kier=$kier'>Firstname $kier_img[3]</a></td>
      </div>   </td>
          <td CLASS='ColumnTD2' nowrap=\"nowrap\"><div align=\"center\">
                <A HREF='$PHP_SELF?sort=4&kier=$kier'>Surname $kier_img[4]</a>
       </div>  </td>
        </tr>
".$tabletxt;
echo $tabletxt;
