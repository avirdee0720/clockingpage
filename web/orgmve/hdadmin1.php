...
<meta http-equiv=\"refresh\" content=\"9;URL=hdadmin1.php?id=$id\",\"GLOWNA\">
</HEAD>
<BODY>";
...
<table WIDTH=95% bordercolorlight='#000000' border='border' style='border-collapse: collapse; background-color: white' >
  ...
  while($w=$baza->Row())
 {
    ...
    FROM hd_status RIGHT JOIN hd_zgloszenie ON hd_status.lp = hd_zgloszenie.stan WHERE hd_zgloszenie.stan=0 ORDER BY hd_zgloszenie.stan ASC, hd_zgloszenie.data DESC";
 }
