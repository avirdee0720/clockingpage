...
echo "	
    <tr>
     ...
     <td class='DataTD' colspan='3'><input class='Input' maxlength='11' name='_nr_zam_pl' size='11' value='$row->nr_zam_pl'> <A HREF='zl_otw.php?idzl=$row->lp'>$BTNOTW: $zl</A></td>
    </td>
   </tr>
    ...
    <tr>
      ...
      <td class='DataTD'><B><input class='Input' maxlength='13' name='_kurs' size='13' value='$row->kurs'></B>&nbsp;PLN</td> 
    </tr>
    <tr>
