...
if(isset($Nowy) and $Nowy=='Zapisz')
    ...
    $query =("INSERT INTO monitor (id_mon, Nr_ewidencyjny, Nr_seryjny, Rok_prod, Producent, Model, id_zest) VALUES(NULL, '$_Nr_ewid', '$_Nr_seryjny', '$_Rok_prod', '$_Dostawca', '$_Model', 1)");
