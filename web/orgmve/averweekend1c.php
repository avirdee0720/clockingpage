...
$tytul = 'Average attendance weekend days 0.75<br>';
...
<form action='/orgmve/averweekend1d.php' method='get' name='ed_czl'>
	...
	<tr>
		<td class='FieldCaptionTD'>Show only people below 0.75</td>
		<td class='DataTD'><input type='checkbox' name='only_below' value='1'></td>
	</tr>
	<tr>
