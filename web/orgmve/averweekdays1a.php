...
$tytul='Average attendance Weekdays (Mon-Fri)<BR>';
...
elseif($state==1)
{
   ...
   echo "<script language='javascript'>window.location=\"averweekdays1b.php?startd=$startd&endd=$endd&_grp=$_grp&showall=$showall\"</script>";
} //fi state=1
else
{
