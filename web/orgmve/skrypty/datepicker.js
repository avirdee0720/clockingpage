//JS DatePicker @0-C005996E

// Date formatting functions begin ---------------------------------------------------


var listMonths = new Array("Styczeñ", "Luty", "Marzec", "Kwiecieñ", "Maj", "Czerwiec", "Lipiec", "Sierpieñ", "Wrzesieñ", "PaŸdziernik", "Listopad", "Grudzieñ");
var listShortMonths = new Array("Sty", "Lut", "Mar", "Kwi", "Maj", "Cze", "Lip", "Sie", "Wrz", "PaŸ", "Lis", "Gru");
var firstWeekDay = "Nie";
var listWeekdays = new Array("Poniedzia³ek", "Wtorek", "Œroda", "Czwartek", "Pi¹tek", "Sobota", "Niedziela");
var listShortWeekdays = new Array("Nie", "Pon", "Wto", "Œro", "Czw", "Pi¹", "Sob");
...
function buildDatePickerParts()
{
  ...
  DatePickerEnd +=
      ...
      (isNav?"":"<FORM NAME='calTable' onSubmit='return false;'>") +
      "<TD>" +
      "<INPUT TYPE='button' CLASS='CalendarButtons' NAME='today' VALUE='Dzisiaj' onClick=\"parent.opener.setToday()\">" + 
      "</TD>" + 
      (isNav?"":"</FORM>")+
      "</TABLE>" +
      (isNav?"</FORM>":"")+
