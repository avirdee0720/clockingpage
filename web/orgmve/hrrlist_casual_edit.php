...
$q = "SELECT id, value, signcode FROM `singlist`";
  ...
  <td CLASS='$row_color' nowrap=\"nowrap\"><b><div align=\"right\">$row->d1&nbsp;</div></b></td>
	<td CLASS='$row_color' nowrap=\"nowrap\" width='280'><b><div align=\"right\"><input class='Input' size='42' maxlength='120' name='textpostoneyear[]' value=\"$row->textpostoneyear\"></b></td>
...
<table border='0' cellpadding='2' cellspacing='1' CLASS='FormTABLE' width='90%'>
  <tr>
