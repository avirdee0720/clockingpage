...
<tr>
    ...
    <td >BonusType</td>
    <td >Today</td>
    <td >Date for Bonus</td>
    <td >Bonus Year Start</td>
    <td >Bonus Year End</td>
    <td >wends TD</td>
    <td >AV TD</td>
    <td >NO need</td>
    <td >AV need</td>
...
$q=$sql;
  ...
  if ($db->Query($q)) 
  {
	...
	$monthX=date("M-y", strtotime($dataToday));
		...
		$BonusYearStart = $PYBS->CurrentBonusYearStartedPayExpSlip();
		$BonusYearEnd = $PYBS->CurrentBonusYearEndPayExpSlip();
