...
$tytul='Average 0.75 weekend days per week required: non-qualifiers below 0.75<BR>';
...
if (!isset($_POST['dir'])) $dir = 1; else $dir = $_POST['dir'];
...
if (!isset($limitvalid)) $limitvalid=0; 
   echo "<script language='javascript'>window.location=\"aver0_7weekend_b0_7_1b.php?startd=$startd&endd=$endd&_grp=$_grp&limit=$limit&dir=$dir&lv=$limitvalid\"</script>";
} //fi state=1
else
{
