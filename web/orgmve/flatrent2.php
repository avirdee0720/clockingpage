...
$month=$month-1;
	...
	for ($i = 0; $i <= $motnhs-1; $i++) {
		$m[$i]=$month+1; 
		echo "<TR><TD>Month <INPUT TYPE='text' NAME='mm[$i]' SIZE='2' VALUE='$m[$i]'></TD><TD> <INPUT TYPE='text' NAME='year[$i]' SIZE='5' VALUE='$year'></TD><TD>£ <INPUT TYPE='text' NAME='mamount[$i]' SIZE='5' VALUE='$small'></TD></TR>";
		$month=$month+1;
     }
