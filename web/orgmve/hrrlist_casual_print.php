...
$q = "SELECT id, value, signcode FROM `singlist`";
  ...
  <td CLASS='$row_color' nowrap=\"nowrap\" width='60'><b>$row->knownas</b></td>
	<td CLASS='$row_color' nowrap=\"nowrap\" width='90'><b>$row->surname</b></td>
  <td CLASS='$row_color' nowrap=\"nowrap\"><b><div align=\"center\" width='60'>$row->catname_staff</b></div></td>
  <td CLASS='$row_color' nowrap=\"nowrap\"><b><div align=\"right\" width='60'>$row->d1</b></div></td>
	<td CLASS='$row_color' nowrap=\"nowrap\" width='360'><b><div align=\"right\">$row->textpostoneyear</b></td>
...
<table border='0' cellpadding='2' cellspacing='1' align='left'>
  <tr>
    ...
    <td CLASS='ColumnTD2' nowrap=\"nowrap\" width='90'><div align=\"center\">
